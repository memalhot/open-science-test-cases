...
CREDENTIALS="${SCRIPT_DIR}/../../model-serving/qwen/credentials.env"
...
JOB_NAME="${JOB_NAME:-qwen-fine-tune}"
BASE_MODEL_PATH="${BASE_MODEL_PATH:-models/Qwen2.5-3B-Instruct}"
OUTPUT_PATH="${OUTPUT_PATH:-models/Qwen2.5-3B-Instruct-finetuned}"
