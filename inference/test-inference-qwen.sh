...
RUN_DIR="${RESULTS_DIR}/${TIMESTAMP}-qwen"
mkdir -p "${RUN_DIR}"
...
run_get_test "readiness-check" "/ready"
...
echo ""
echo "========================================="
echo "  Qwen Results: ${PASSED} passed, ${FAILED} failed"
echo "  Output:  ${RUN_DIR}"
echo "========================================="
