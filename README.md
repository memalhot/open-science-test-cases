...
| Label & Taint Checks | Verifies GPU node labels (NFD, gpu.count, gpu.product, gpu.memory) and taints (nvidia.com/gpu.product:NoSchedule) to ensure proper GPU isolation | Platform Readiness | [component-checks/label-checks.sh](https://github.com/memalhot/open-science-test-cases/tree/main/component-checks/label-checks.sh) |
