...
| Agent Deployment | Tests agent deployment verification based on RHOAI 3.4 AgentCard and AgentRuntime features, including discovery, sidecar injection, and tracing | Agent Testing | [agent-deployment](https://github.com/memalhot/open-science-test-cases/tree/main/agent-deployment) |
