...
| Open WebUI | Public chat UI for interacting with the deployed model, using [Open WebUI](https://github.com/open-webui/open-webui) on OpenShift | Endpoints | [endpoints/open-webui](https://github.com/memalhot/open-science-test-cases/tree/main/endpoints/open-webui) |
